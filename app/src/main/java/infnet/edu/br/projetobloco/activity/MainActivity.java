package infnet.edu.br.projetobloco.activity;
...
import infnet.edu.br.projetobloco.API.ApiClient;
import infnet.edu.br.projetobloco.API.GitHubApi;
import infnet.edu.br.projetobloco.R;
import infnet.edu.br.projetobloco.adapter.RecyclerAdapter;
import infnet.edu.br.projetobloco.adapter.RecyclerSampleAdapter;
import infnet.edu.br.projetobloco.model.GitHubCatalog;
import infnet.edu.br.projetobloco.model.Repository;
...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String TAG = "projeto";
